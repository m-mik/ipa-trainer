...
const IPA: Alphabet = {
  vowels: {
    long: [
      ...
      { id: 5, name: 'ɜː', example: 'b[i]rd', language: Language.UK },
      { id: 6, name: 'ɝː', example: 'w[or]m', language: Language.US },
    ],
    short: [
      { id: 7, name: 'ɪ', example: 'sh[i]p' },
      { id: 8, name: 'æ', example: 'h[a]t' },
      { id: 9, name: 'ʊ', example: 'f[oo]t' },
      { id: 10, name: 'ɒ', example: 's[o]ck', language: Language.UK },
      { id: 11, name: 'ʌ', example: 'c[u]p' },
      { id: 12, name: 'e', example: 'h[ea]d' },
      { id: 13, name: 'ə', example: '[a]bove' },
      { id: 14, name: 'ɚ', example: 'moth[er]', language: Language.US },
    ],
  },
  consonants: {
    voiced: [
